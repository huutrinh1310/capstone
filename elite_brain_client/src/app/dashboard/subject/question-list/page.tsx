...
//     }
//
//     const [showFormQuestion, setShowFormQuestion] = React.useState(false);
//
...
//             id: 1,
//             key: 'A',
//             explain: 'because is true',
//             isCorrect: true,
//             content: 'When a syntax error occurs',
//         },
//         {
//             id: 2,
//             key: 'B',
...
//         {
//             id: 1,
//             question: 'When does an exception in Java arises in code sequence?',
//             questionType: QuestionType.FILL,
//             choices,
//             description: 'kdfsjlkajdflkjasd',
//             subjectName: 'Java',
//             topicName: 'Exception',
//         },
//         {
//             id: 2,
//             question: 'When does an exception in Java fasdf sequence?',
...
//         setaddNewQuestions([...addNewQuestions, { id: uuidv4(), form: 'question', question: '', type: 'MCQ', choices: []}])
//     }
//
...
//                 <div>
//                     <div className='mb-5'>
//                         <span className='text-text-100 text-2xl me-2'>{topic[0].topic}</span>
//                         <FontAwesomeIcon
//                             icon={faChevronRight}
//                             className='text-text-200 text-sm me-2'
//                         />
//                         <span className='text-text-100 text-2xl'>{topic[0].title}</span>
//                     </div>
//                     <div>
//                         <span className='text-text-400 text-5xl font-bold'>{topic[0].title}</span>
//                     </div>
//                 </div>
//
...
//                     {/*<button*/}
//                     {/*    className="bg-slate-400 self-end rounded-md py-1 px-5 me-5"*/}
//                     {/*    onClick={showCreateQuestion}*/}
//                     {/*>*/}
//                     {/*    {showFormQuestion ? 'Cancel' : 'Create Question'}*/}
//                     {/*</button>*/}
//
//                     <button
...
//                     </div>
//                 </div>
//                 <ListQuestion className='w-full ps-24 pe-44' listQuestion={listQuestion} />
//             </div>
//         </main>
//     );
// }
